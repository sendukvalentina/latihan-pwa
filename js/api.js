        ...
        teamsHTML += `
                ...
                <div class = "col s12">
                  <div class = "card">
                    ...
                    <p align="center">Nickname : ${data.shortName}
                      <br>Address: ${data.address}
                      <br>Founded: ${data.founded}
                      <br>Club Colors: ${data.clubColors}
                      <br>Venue: ${data.venue}
                    </p
                  </div>
                  </div>
      ...
      let btn = document.querySelectorAll(".btn-floating");
          for(let button of btn){
            button.addEventListener("click", function(event){
              ...
              console.log(id);
              var toastHTML = `<span> Successfuly remove the team from favorite</span>
